...
void app_main(void)
{
    ...
    spilcd_show_string(10, 70,  200, 16, 16, "RTC TEST", RED);
    ...
    while (1)
    {
        ...
        if ((t % 10) == 0)      /* 每100ms更新一次显示数据 */
        {
            ...
            spilcd_show_string(10, 130, 210, 16, 16, (char *)tbuf,BLUE);
            sprintf((char *)tbuf, "Date:%04d-%02d-%02d", calendar.year, calendar.month, calendar.date);
            spilcd_show_string(10, 150, 210, 16, 16, (char *)tbuf,BLUE);
            sprintf((char *)tbuf, "Week:%s", weekdays[calendar.week]);
            spilcd_show_string(10, 170, 210, 16, 16, (char *)tbuf,BLUE);
        }
